...
(function (angular, factory) {
     ...
     * @example
     ...
     <doc:source>
     <script>
     var app = angular.module('myApp', ['ui.table']);
     ...
     */
    var app = angular.module('ui.table', []);
    /**
     * ngTable: Table + Angular JS
     *
     * @author Vitalii Savchuk <esvit666@gmail.com>
    ...
    angular.module('ui.table').run(['$templateCache', function ($templateCache) {
...
(function () {
    ...
    angular
        ...
        .run(function ($commonVersion, $log) {
            $log.info('Alerter UI Framework ', $commonVersion);
        });
}());
;
...
angular.module('template/organisation/select-organisation.tpl.html', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('template/organisation/select-organisation.tpl.html',
    ...
    '        {{ assignee.userFullName || assignee.groupName || \'Select element...\' | translate}}\n' +
    '    </a>\n' +
    '\n' +
